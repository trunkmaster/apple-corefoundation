...
// note: if we ever need to use symbol names which are not valid C identifiers, it might be possible to use #pragma redefine_extname or __asm__("symbol name")

#define STATIC_CLASS_PREFIX _OBJC_CLASS_

#define __NSCFBoolean _NSCFBoolean
#define __NSCFNumber _NSCFNumber
#define __NSCFType NSCFType

#define STATIC_CLASS_NAME_CONCAT_INNER(x,y) x ## y
#define STATIC_CLASS_NAME_CONCAT(x,y) STATIC_CLASS_NAME_CONCAT_INNER(x,y)
#define STATIC_CLASS_NAME_STRINGIFY_INNER(x) #x
#define STATIC_CLASS_NAME_STRINGIFY(x) STATIC_CLASS_NAME_STRINGIFY_INNER(x)

#define STATIC_CLASS_NAME(CLASSNAME) CLASSNAME

#define DECLARE_STATIC_CLASS_REF(CLASSNAME) extern void STATIC_CLASS_NAME_CONCAT(STATIC_CLASS_PREFIX, STATIC_CLASS_NAME(CLASSNAME)) __asm__(STATIC_CLASS_NAME_STRINGIFY(.STATIC_CLASS_NAME_CONCAT(STATIC_CLASS_PREFIX, STATIC_CLASS_NAME(CLASSNAME))))
#define STATIC_CLASS_REF(CLASSNAME) &(STATIC_CLASS_NAME_CONCAT(STATIC_CLASS_PREFIX, STATIC_CLASS_NAME(CLASSNAME)))
