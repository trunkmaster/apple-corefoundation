...
// SPDX-FileCopyrightText: 2011-2015 Apple Inc. <>

// From https://github.com/apple-oss-distributions/CF/blob/CF-1153.18/Examples/plconvert.c
//      (CF-1153.18, OS X 10.10.3-10.10.5 (2015))
//      (based on CF-635, OS X 10.7.0-10.7.1 (2011))
