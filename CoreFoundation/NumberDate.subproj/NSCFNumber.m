...
#import <CoreFoundation/NSCFNumber.h>
...
#define NS_NUMBER_INIT_IMPL(cfNumberType, ...)                                                                                        \
    (instancetype) __VA_ARGS__ num {                                                                                                  \
        return (NSNumberPrototype*)((NSNumber*)(CFNumberCreate(kCFAllocatorDefault, cfNumberType, &num))); \
    }
...
#define NS_NUMBER_INIT_UNSIGNED_IMPL(cfNumberType, intermediateType, ...)                           \
    (instancetype) __VA_ARGS__ num {                                                                \
        intermediateType castedNum = (intermediateType)(num);                            \
        return (NSNumberPrototype*)(                                                \
            (NSNumber*)(CFNumberCreate(kCFAllocatorDefault, cfNumberType, &castedNum))); \
    }
...
- (instancetype)initWithUnsignedLongLong:(unsigned long long)num {
    ...
    castedNum.low = num;
    return (NSNumberPrototype*)(
        (NSNumber*)(CFNumberCreate(kCFAllocatorDefault, (CFNumberType)(kCFNumberSInt128Type), &castedNum)));
}

// For bool, return the extant constants
- (instancetype)initWithBool:(BOOL)value {
    return (NSNumberPrototype*)((NSNumber*)(value ? kCFBooleanTrue : kCFBooleanFalse));
}
